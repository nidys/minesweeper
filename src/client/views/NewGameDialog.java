...
public class NewGameDialog extends DialogBase {
	...
	private void buildGUI() {
		...
		getContentPane().setLayout(null);
		{
			...
			Type.setBorder(new TitledBorder(UIManager
					.getBorder("TitledBorder.border"), "Difficulty:",
		...
		{
			classicGameButton = new JToggleButton(GameMode.CLASSIC.toString());
			classicGameButton.setBounds(10, 10, 75, 32);
		}
		{
			sharedGameButton = new JToggleButton(GameMode.SHARED.toString());
			sharedGameButton.setBounds(107, 10, 75, 32);
		}
		{
			perksGameButton = new JToggleButton(GameMode.PERKS.toString());
